...
function App() {const [password, setpassword] = useState("")
...
function generatePassword() {
  ...
  if(!passwordLength) {
    ...
    confirmLower = window.confirm("Will this contain lower case letters?");
    console.log("Lower case " + confirmLower);
    confirmUpper = window.confirm("Will this contain upper case letters?");
